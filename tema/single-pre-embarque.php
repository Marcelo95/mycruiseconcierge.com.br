	...
	<form autocomplete="off" ng-show="menu==2" name="my_form2" ng-class="['mt-20', {'form-submited' : myForm2.is_submitted}]">
		...
		<div class="col-sm-6">
			<div class="form-group" ng-class="{'has-error-disable' : my_form2.cpf_contratante.$invalid || cpfExist(data.contratante.cpf_contratante, 'cpf_contratante', 1 )  }">
				<input type="text" cpf-valido="data.contratante.nacionalidade_contratante=='Brasil'" class="input-placeholder cpf" ng-class="{'cpf-invalid' : cpfExist(data.contratante.cpf_contratante, 'cpf_contratante', 1 )}" data-disable-ng-pattern='pattern_CPF' name="cpf_contratante" ng-required="data.contratante.nacionalidade_contratante=='Brasil'" placeholder="*cpf" id="cpf_contratante" ng-model="data.contratante.cpf_contratante">
			...
			<div class="row hospede_1" ng-if="data.hospede.quantidade_hospedes>=1">
				...
				<div class="col-sm-6">
					<div class="form-group" ng-class="{'has-error-disable' : my_form3.cpf_hospede_1.$invalid || cpfExist(data.hospede.cpf_hospede_1, 'cpf_hospede_1', data.hospede.is_hospede_1 ) }">
						<input type="text" cpf-valido="data.hospede.nacionalidade_hospede_1=='Brasil'" class="cpf input-placeholder" ng-class="{'cpf-invalid' : cpfExist(data.hospede.cpf_hospede_1, 'cpf_hospede_1', data.hospede.is_hospede_1 )}" data-disable-ng-pattern='pattern_CPF' name="cpf_hospede_1" placeholder="*cpf" id="cpf_hospede_1" ng-required="data.hospede.quantidade_hospedes>=1 && data.hospede.nacionalidade_hospede_1=='Brasil'" ng-model="data.hospede.cpf_hospede_1">
			...
			<div class="row hospede_3" ng-if="data.hospede.quantidade_hospedes>=3">
				...
				<div class="col-sm-6">
					<div class="form-group" ng-class="{'has-error-disable' : my_form3.cpf_hospede_3.$invalid || cpfExist(data.hospede.cpf_hospede_3, 'cpf_hospede_3', 0 )  }">
						<input type="text" cpf-valido="data.hospede.nacionalidade_hospede_3=='Brasil'" class="cpf input-placeholder" ng-class="{'cpf-invalid' : cpfExist(data.hospede.cpf_hospede_3, 'cpf_hospede_3', 0 )}" data-disable-ng-pattern='pattern_CPF' name="cpf_hospede_3" placeholder="*cpf" id="cpf_hospede_3" ng-required="data.hospede.quantidade_hospedes>=3 && data.hospede.nacionalidade_hospede_3=='Brasil'" ng-model="data.hospede.cpf_hospede_3">
			...
			<div class="row hospede_4" ng-if="data.hospede.quantidade_hospedes>=4">
				...
				<div class="col-sm-6">
					<div class="form-group" ng-class="{'has-error-disable' : my_form3.cpf_hospede_4.$invalid || cpfExist(data.hospede.cpf_hospede_4, 'cpf_hospede_4', 0 ) }">
						<input type="text" cpf-valido="data.hospede.nacionalidade_hospede_4=='Brasil'" class="cpf input-placeholder" ng-class="{'cpf-invalid' : cpfExist(data.hospede.cpf_hospede_4, 'cpf_hospede_4', 0 )}" data-disable-ng-pattern='pattern_CPF' name="cpf_hospede_4" placeholder="*cpf" id="cpf_hospede_4" ng-required="data.hospede.quantidade_hospedes>=4 && data.hospede.nacionalidade_hospede_4=='Brasil'" ng-model="data.hospede.cpf_hospede_4">
